...
class GameActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        buttonBatu.setOnClickListener {
            ...
            textKomputer.text = ""
             Handler().postDelayed({
                 textHasilGame.text = suwit (pilihanPlayer,pilihanKomputer)
    ...
    fun suwit(pilihanPlayer:Int, pilihanKomputer:Int):String{
        ...
        if(pilihanPlayer == pilihanKomputer) {
            hasil = "SERI"
            textHasilGame.setTextColor(Color.GRAY)
        }
            ...
            hasil = "YOU LOSE :( "
            textHasilGame.setTextColor(Color.RED)
        }
        else {
            hasil = "YOU WIN"
            textHasilGame.setTextColor(Color.GREEN)
        }
        return hasil
    }
